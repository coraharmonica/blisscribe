...
books = dict.fromkeys(titles, texts)

kjv = texts[3]
leaves_of_grass = texts[-1]
wizard_of_oz = """
...
not like to drop the jar for fear of killing somebody, so managed to put it into one of the cupboards as she fell \
past it.
...
aloud. `I must be getting somewhere near the centre of the earth. Let me see: that would be four thousand miles down, \
I think--' (for, you see, Alice had learnt several things of this sort in her lessons in the schoolroom, and though \
this was not a very good opportunity for showing off her knowledge, as there was no one to listen to her, still it \
was good practice to say it over) `--yes, that's about the right distance--but then I wonder what Latitude or \
Longitude I've got to?' (Alice had no idea what Latitude was, or Longitude either, but thought they were nice grand \
words to say.)

Presently she began again. `I wonder if I shall fall right through the earth! How funny it'll seem to come out among \
the people that walk with their heads downward! The Antipathies, I think--' (she was rather glad there was no one \
...
to-night, I should think!' (Dinah was the cat.) `I hope they'll remember her saucer of milk at tea-time. Dinah my dear! \
I wish you were down here with me! There are no mice in the air, I'm afraid, but you might catch a bat, and that's very \
like a mouse, you know. But do cats eat bats, I wonder?' And here Alice began to get rather sleepy, and went on saying \
to herself, in a dreamy sort of way, `Do cats eat bats? Do cats eat bats?' and sometimes, `Do bats eat cats?' for, you \
see, as she couldn't answer either question, it didn't much matter which way she put it. She felt that she was dozing \
off, and had just begun to dream that she was walking hand in hand with Dinah, and saying to her very earnestly, `Now, \
...
My drawing was not a picture of a hat. It was a picture of a boa constrictor digesting an elephant. But since the grown-ups \
were not able to understand it, I made another drawing: I drew the inside of a boa constrictor, so that the grown-ups could \
see it clearly. They always need to have things explained.
"""