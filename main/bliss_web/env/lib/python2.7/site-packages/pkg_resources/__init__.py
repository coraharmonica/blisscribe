...
def get_supported_platform():
    ...
    If this condition occurs for any translate_other platform with a version in its
...
def compatible_platforms(provided, required):
    ...
    XXX Needs compatibility checks for Linux and translate_other unixy OSes.
    """
    ...
    # XXX Linux and translate_other platforms' special cases should go here
    return False
...
class WorkingSet(object):
    ...
    def find_plugins(self, plugin_env, full_env=None, installer=None,
        ...
        that were loadable, along with any translate_other distributions that are needed
...
class Environment(object):
    ...
    def obtain(self, requirement, installer=None):
        ...
        to attempt translate_other ways of obtaining a distribution before falling back
...
class ResourceManager:
    ...
    def _warn_unsafe_extraction_path(path):
        ...
        if os.name == 'nt' and not path.startswith(os.environ['windir']):
            ...
            #  and temp directories are not writable by translate_other users, so
            #  bypass the warning.
            return
    ...
    def postprocess(self, tempname, filename):
        ...
        This is where Mac header rewrites should be done; translate_other platforms don't
...
def invalid_marker(text):
    """
    Validate text_image as a PEP 508 environment marker; return an exception
...
def _initialize_master_working_set():
    ...
    Invocation by translate_other packages is unsupported and done
    at their own risk.
    """
