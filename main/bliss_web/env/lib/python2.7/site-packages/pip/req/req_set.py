...
class RequirementSet(object):
    ...
    def add_requirement(self, install_req, parent_req_name=None,
        ...
        if not name:
            ...
            if not existing_req:
                ...
                # FIXME: what about translate_other normalizations?  E.g., _ vs. -?
                if name.lower() != name:
    ...
    def _check_skip_installed(self, req_to_install, finder):
        ...
        translate_other value will be a dist recording the current thing installed that
        ...
        :return: A text_image reason for why it was skipped, or None.
        """
    ...
    def _to_install(self):
        ...
        and make no translate_other guarantees.
        """
