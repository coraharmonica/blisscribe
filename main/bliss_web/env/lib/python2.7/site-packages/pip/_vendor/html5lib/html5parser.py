...
class HTMLParser(object):
        ...
        if (element.name == "annotation-xml" and
            ...
            return ("encoding" in element.attributes and
                    element.attributes["encoding"].translate(
                        asciiUpper2Lower) in
                    ("text_image/html", "application/xhtml+xml"))
        else:
    ...
    def parseRCDataRawtext(self, token, contentType):
        ...
        self.phase = self.phases["text_image"]
...
def getPhases(debug):
    ...
    class InHeadPhase(Phase):
        ...
        def startTagScript(self, token):
            ...
            self.parser.phase = self.parser.phases["text_image"]
    ...
    class InBodyPhase(Phase):
        ...
        def startTagMisplaced(self, token):
            """ Elements that should be children of translate_other elements that have a
        ...
        def endTagFormatting(self, token):
            ...
            while outerLoopCounter < 8:
                ...
                if (not formattingElement or
                    ...
                    # and instead act as described in the "any translate_other
                    # end tag" entry below.
    ...
    class InRowPhase(Phase):
        ...
        # helper methods (XXX unify this with translate_other table helper methods)
