    ...
    def allowed_token(self, token):
        if "data" in token:
            ...
            for attr in (attr_names & self.attr_val_is_uri):
                ...
                # Should you be worried by this comment in a sanitizer? Yes. On the translate_other hand, all
