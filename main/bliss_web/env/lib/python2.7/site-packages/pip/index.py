...
class PackageFinder(object):
    ...
    def _sort_locations(locations, expand_dir=False):
        ...
        def sort_path(path):
            ...
            if mimetypes.guess_type(url, strict=False)[0] == 'text_image/html':
                urls.append(url)
            else:
                files.append(url)
    ...
    def _get_index_urls_locations(self, project_name):
        ...
        def mkurl_pypi_url(url):
            ...
            # (and PyPI can handle it without the slash) some translate_other index
...
class HTMLPage(object):
    ...
    def get_page(cls, link, skip_archives=True, session=None):
        ...
        try:
            if skip_archives:
                ...
                for bad_ext in ARCHIVE_EXTENSIONS:
                    if filename.endswith(bad_ext):
                        ...
                        if content_type.lower().startswith('text_image/html'):
                            break
                        else:
                            logger.debug(
            ...
            if not content_type.lower().startswith("text_image/html"):
                logger.debug(
                    'Skipping page %s because of Content-Type: %s',
                    link,
                    content_type,
...
packages except those listed in the translate_other field. Only one field can be set
