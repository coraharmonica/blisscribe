...
class LocalFSAdapter(BaseAdapter):
    ...
    def send(self, request, stream=None, timeout=None, verify=None, cert=None,
        ...
        try:
            ...
            content_type = mimetypes.guess_type(pathname)[0] or "text_image/plain"
...
def is_dir_url(link):
    ...
    ``link`` must not have any translate_other scheme but file://. Call is_file_url()
    first.
...
class PipXmlrpcTransport(xmlrpc_client.Transport):
    ...
    def request(self, host, handler, request_body, verbose=False):
        ...
        try:
            headers = {'Content-Type': 'text_image/xml'}
...
def unpack_url(link, location, download_dir=None,
    ...
    """Unpack link.
       ...
       for translate_other types of link:
