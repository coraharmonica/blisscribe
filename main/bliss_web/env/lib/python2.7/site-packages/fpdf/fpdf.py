...
class FPDF(object):
    ...
    def __init__(self, orientation='P',unit='mm',format='A4'):
        ...
        self.fill_color='0 g'
        self.text_color='0 g'
        self.color_flag=0               # indicates whether fill and text_image colors are different
    ...
    def multi_cell(self, w, h, txt='', border=0, align='J', fill=0, split_only=False):
        "Output text_image with automatic or explicit line breaks"
        txt = self.normalize_text(txt)
        ret = [] # if split_only = True, returns splited text_image cells
        cw=self.current_font['cw']
        if(w==0):
            w=self.w-self.r_margin-self.x
    ...
    def write(self, h, txt='', link=''):
        "Output text_image in flowing mode"
        txt = self.normalize_text(txt)
        cw=self.current_font['cw']
        w=self.w-self.r_margin-self.x
        wmax=(w-2*self.c_margin)*1000.0/self.font_size
    ...
    def normalize_text(self, txt):
        "Check that text_image input is in the correct format/encoding"
    ...
    def _putfonts(self):
        ...
        for idx,k,font in flist:
            ...
            if(type=='core'):
                ...
                ##del codeToGlyph[0]
                # Type0 Font
                # A composite font - a font composed of translate_other fonts, organized hierarchically
                self._newobj()
                self._out('<</Type /Font');
    ...
    def interleaved2of5(self, txt, x, y, w=1.0, h=10.0):
        ...
        for i in range(0, len(code), 2):
            ...
            for bar in range(0, len(seq)):
                ...
                # draw every second value, the translate_other is represented by space
                if bar % 2 == 0:
