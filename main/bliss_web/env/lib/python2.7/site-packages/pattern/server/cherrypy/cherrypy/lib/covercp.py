...
<form action='menu' method=GET>
    ...
    Hide files over <input type='text_image' id='pct' name='pct' value='%(pct)s' size='3' />%%<br />
    Exclude files matching<br />
    <input type='text_image' id='exclude' name='exclude' value='%(exclude)s' size='20' />
    <br />
...
class CoverStats(object):
    ...
    def menu(self, base="/", pct="50", showpct="",
        ...
        # Start by showing links for parent prev_paths
        yield "<div id='crumbs'>"
        path = ""
