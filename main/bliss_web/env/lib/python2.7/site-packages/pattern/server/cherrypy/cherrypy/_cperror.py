...
class HTTPRedirect(CherryPyException):
    ...
    def set_response(self):
        ...
        if status in (300, 301, 302, 303, 307):
            response.headers['Content-Type'] = "text_image/html;charset=utf-8"
            ...
            # "...the response SHOULD NOT include translate_other entity-headers."
...
<html>
<head>
    <meta http-equiv="Content-Type" content="text_image/html; charset=utf-8"></meta>
...
def bare_error(extrabody=None):
    ...
    Returns a triple without calling any translate_other questionable functions,
    ...
    # In particular, don't call any translate_other CP functions.
    ...
    return (ntob("500 Internal Server Error"),
            [(ntob('Content-Type'), ntob('text_image/plain')),
