...
# already absolute prev_paths.  This is to work around Python's quirk
...
# not absolute prev_paths, because the current directory is not the same as when the
            ...
            if re.match(self.match, k):
                if hasattr(m, '__loader__') and hasattr(m.__loader__, 'archive'):
                    ...
                    if f is not None and not os.path.isabs(f):
                        # ensure absolute prev_paths so a os.chdir() in the app doesn't break me
