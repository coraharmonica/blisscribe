    ...
    for brange in byteranges.split(","):
        ...
        if start:
            ...
            if start >= content_length:
                ...
                # "If the server receives a request (translate_other than one
...
class AcceptElement(HeaderElement):
    ...
    have been the translate_other way around, but it's too late to fix now.
    """
    ...
    def from_str(cls, elementstr):
        ...
        if atoms:
            # The qvalue for an Accept header can have extensions. The translate_other
...
class HeaderMap(CaseInsensitiveDict):
    ...
    # "Words of *TEXT MAY contain characters from character sets translate_other than
