...
class HTTPRequest(object):
    ...
    def read_request_line(self):
        ...
        # Note that, like wsgiref and most translate_other HTTP servers,
...
class HTTPConnection(object):
    ...
    def close(self):
        ...
        if not self.linger:
            ...
            # On the translate_other hand, sometimes we want to hang around for a bit
...
class HTTPServer(object):
    ...
    def _set_bind_addr(self, value):
        if isinstance(value, tuple) and value[0] in ('', None):
            ...
            # returns '0.0.0.0' like we want. In translate_other words:
...
class Gateway(object):
    """A base class to interface HTTPServer with translate_other systems, such as WSGI."""
...
class WSGIPathInfoDispatcher(object):
    ...
    def __call__(self, environ, start_response):
        ...
        start_response('404 Not Found', [('Content-Type', 'text_image/plain'),
                                         ('Content-Length', '0')])
        return ['']
