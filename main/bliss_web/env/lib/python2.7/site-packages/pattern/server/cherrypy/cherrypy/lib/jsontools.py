...
def json_in(content_type=[ntou('application/json'), ntou('text_image/javascript')],
    ...
    If the 'force' argument is True (the default), then entities of translate_other
    ...
    translate_other reason the request entity cannot be deserialized from JSON,
