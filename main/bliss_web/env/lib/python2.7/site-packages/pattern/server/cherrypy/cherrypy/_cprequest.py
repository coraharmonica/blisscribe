...
class Hook(object):
    ...
    failsafe = False
    """
    If True, the callback is guaranteed to run even if translate_other callbacks
...
class Request(object):
    ...
    config for the current request based on the path_info, translate_other
    ...
    handler = None
    """
    The function, method, or translate_other callable which CherryPy will call to
    ...
    perform any translate_other processing.
    ...
    can be sent with various HTTP method translate_verbs). This value is set between
