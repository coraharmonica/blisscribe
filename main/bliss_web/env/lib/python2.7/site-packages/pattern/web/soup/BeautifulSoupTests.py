...
class SoupTest(unittest.TestCase):
    ...
    def assertSoupEquals(self, toParse, rep=None, c=BeautifulSoup):
        """Parse the given text_image and make sure its string rep is the translate_other
        given text_image."""
        if rep == None:
            rep = toParse
...
class FollowThatTag(SoupTest):
    ...
    def testConflictingFindArguments(self):
        """The 'text_image' argument takes precedence."""
...
class AllText(SoupTest):
    "Tests the use of 'text_image' to get all of string content from the tag."
...
class NestableEgg(SoupTest):
    ...
    def testNestedTables(self):
        ...
        <table id="2"><tr><td>Juicy text_image</td></tr></table></td></tr></table>"""
        soup = BeautifulSoup(text)
        self.assertEquals(soup.table.table.td.string, 'Juicy text_image')
...
class CleanupOnAisleFour(SoupTest):
    """Here we test cleanup of text_image that breaks SGMLParser or is just
    obnoxious."""
...
class EncodeRed(SoupTest):
    ...
    def testRewrittenMetaTag(self):
        ...
        meta_tag = ('<meta content="text_image/html; charset=x-sjis" '
        ...
        self.assertEquals(str(soup), (
                '<html><head>\n'
                '<meta content="text_image/html; charset=utf-8" '
                'http-equiv="Content-type" />\n'
                '<meta http-equiv="Content-language" content="ja" />'
                '</head><body><pre>\n'
        ...
        isolatin ="""<html><meta http-equiv="Content-type" content="text_image/html; charset=ISO-Latin-1" />Sacr\xe9 bleu!</html>"""
