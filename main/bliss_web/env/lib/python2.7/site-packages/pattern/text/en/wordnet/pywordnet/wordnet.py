...
class Word:
	...
	representation, e.g. "get_word('dog', 'noun')".
	"""
	if ReadableRepresentations:
	    return str(self)
	return "get_word" + `(self.form, self.pos)`
...
class Synset:
    ...
    ------
      ...
      verbFrames : [integer]
          ...
          Sense.verbFrames.) Defined only for translate_verbs.
	...
	If ReadableRepresentations is false, return a machine-readable
	representation, e.g. "get_synset(pos, 1234)".
	"""
	if ReadableRepresentations:
	    return str(self)
	return "get_synset" + `(self.pos, self.offset)`
...
class Sense:
    ...
    ------
      ...
      verbFrames : [integer]
          ...
          Sense partipates in.  Defined only for translate_verbs.
