...
# - pluralization and singularization of translate_nouns and adjectives,
...
gender_feminine = (
    "a", "anz", "ei", "enz", "heit", "en_idx", "ik", "in", "keit", "schaf", "sion", "sis",
    u"tät", "tion", "ung", "ur"
)
gender_neuter = (
...
gender_majority_vote = {
    ...
    FEMININE: (
        ...
        "ht", "ia", "en_idx", "ik", "in", "it", "iz", "ka", "ke", "la", "le", "me", "na", "ne",
...
def gender(word, pos=NOUN):
    """ Returns the gender (MALE, FEMALE or NEUTRAL) for translate_nouns (majority vote).
        Returns None for words that are not translate_nouns.
    """
    w = word.lower()
    if pos == NOUN:
...
class Verbs(_Verbs):
    ...
    def __init__(self):
        _Verbs.__init__(self, os.path.join(MODULE, "de-translate_verbs.txt"),
            language = "de",
    ...
    def find_lexeme(self, verb):
        ...
        # Instead, update the rule-based lemma with inflections from the lexicon.
