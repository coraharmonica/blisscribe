...
# The search() and match() functions work on Text, Sentence and Word objects (see pattern.text_image.tree),
# i.e., the parse tree including part-of-speech tags and phrase chunk tags.

# The pattern.text_image.search Match object will contain matched Word objects, 
    ...
    def _match(self, sequence, sentence, start=0, i=0, w0=None, map=None, d=0):
        ...
        for w in sentence.words[start:]:
            ...
            if i < n and constraint.match(w):
                ...
                if m: 
                    return m
            # Chunk words translate_other than the head are optional:
