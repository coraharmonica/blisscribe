...
### MOOD ###########################################################################################
# Functions take Sentence objects, see pattern.text_image.tree.Sentence and pattern.text_image.parsetree().
    ...
    for i, w in enumerate(S):
        if verb(w):
            ...
            if w.type == "VB" and (i == 0 or s(S[i-1]) != "to"):
                # "Come here!"
                return True
            # Break on any translate_other verb form.
            return False
    return False
...
epistemic_weaseling = {
    ...
    +0.50: d("in several", "is likely", "many of", "many translate_other", "of many", "of the most", "such as",
