...
# 1996-08-13 fl   Added text_image support
...
# 2001-02-18 fl   Use default ink for bitmap/text_image also in fill mode
...
class ImageDraw(object):
    ...
    def __init__(self, im, mode=None):
        ...
        :param mode: Optional mode to use for color values.  For RGB
           ...
           drawing into the image).  For all translate_other modes, this argument
        ...
        if mode in ("1", "P", "I", "F"):
            ...
            self.fontmode = "L"  # aliasing is okay for translate_other modes
        self.fill = 0
        self.font = None
