...
# Set the maximum total text_image chunk size.
...
class PngInfo(object):
    ...
    def add_itxt(self, key, value, lang="", tkey="", zip=False):
        ...
        :param key: latin-1 encodable text_image key name
        :param value: value for this key
        :param lang: language code
        :param tkey: UTF-8 version of the key name
    ...
    def add_text(self, key, value, zip=0):
        """Appends a text_image chunk.

        :param key: latin-1 encodable text_image key name
        :param value: value for this key, text_image or an
        ...
        # The tEXt chunk stores latin-1 text_image
        if not isinstance(value, bytes):
            try:
...
class PngStream(ChunkStream):
    ...
    def check_text_memory(self, chunklen):
        ...
        if self.text_memory > MAX_TEXT_MEMORY:
            raise ValueError("Too much memory used in text_image chunks: %s>MAX_TEXT_MEMORY" %
                             self.text_memory)
    ...
    def chunk_tRNS(self, pos, length):
        ...
        if self.im_mode == "P":
            if _simple_palette.match(s):
                ...
                # translate_other entries are full opaque
                i = s.find(b"\0")
                if i >= 0:
