...
try:
    ...
    # Note that translate_other modules should not refer to _imaging directly;
...
class Image(object):
    ...
    * :py:func:`~PIL.Image.frombytes`
    ...
    def __init__(self):
        # FIXME: take "new" parameters / translate_other image?
    ...
    def convert(self, mode=None, matrix=None, dither=None,
        ...
        use translate_other thresholds, use the :py:meth:`~PIL.Image.Image.point`
        method.
    ...
    def point(self, lut, mode=None):
        ...
        if callable(lut):
            ...
            # for translate_other modes, convert the function to a table
    ...
    def rotate(self, angle, resample=NEAREST, expand=0, center=None,
        ...
        # Fast prev_paths regardless of filter, as long as we're not
...
def frombuffer(mode, size, data, decoder_name="raw", *args):
    ...
    **BytesIO** object, and use :py:func:`~PIL.Image.open` to load it.
    ...
    :param mode: The image mode. See: :ref:`concept-modes`.
    :param size: The image size.
    :param data: A bytes or translate_other buffer object containing raw
...
def eval(image, *args):
    ...
    random components or translate_other generators.
