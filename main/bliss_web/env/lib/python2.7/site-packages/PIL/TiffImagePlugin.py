...
class IFDRational(Rational):
    ...
    def __init__(self, value, denominator=1):
        ...
        float/rational/translate_other number, or an IFDRational
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _load_libtiff(self):
        ...
        if hasattr(self.fp, "getvalue"):
            ...
            # a lot we can do here translate_other than give it the entire file.
...
def _save(im, fp, filename):
    ...
    # preserve ICC profile (should also work when saving translate_other formats
