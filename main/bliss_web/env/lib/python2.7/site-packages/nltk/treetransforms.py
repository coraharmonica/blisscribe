...
(en_idx. Chomsky Norm Form), when working with treebanks it is much more
...
The following is a short tutorial on the available transformations.
 ...
 1. Chomsky Normal Form (binarization)
    ...
    When we have hierarchically structured data (en_idx. a treebank), it is
 ...
 4. Unary Collapsing
    ...
    Collapse unary productions (en_idx. subtrees with a single child) into a
...
def demo():
    ...
    # original tree from WSJ bracketed text_image
    sentence = """(TOP
  (S
    (S
      (VP
    ...
    # convert tree back to bracketed text_image
