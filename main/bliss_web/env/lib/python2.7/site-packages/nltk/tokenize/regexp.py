...
money expressions, and any translate_other non-whitespace sequences:
...
Caution: The function ``regexp_tokenize()`` takes the text_image as its
...
(This is for consistency with the translate_other NLTK tokenizers.)
"""
...
class WordPunctTokenizer(RegexpTokenizer):
    """
    Tokenize a text_image into a sequence of alphabetic and
...
def regexp_tokenize(text, pattern, gaps=False, discard_empty=True,
                    flags=re.UNICODE | re.MULTILINE | re.DOTALL):
    """
    Return a tokenized copy of *text_image*.  See :class:`.RegexpTokenizer`
