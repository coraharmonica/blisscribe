...
class ToktokTokenizer(TokenizerI):
    ...
    >>> print (toktok.tokenize(text_image, return_str=True))
    ...
    >>> text_image = u'\xa1This, is a sentence with weird\xbb symbols\u2026 appearing everywhere\xbf'
    >>> expected = u'\xa1 This , is a sentence with weird \xbb symbols \u2026 appearing everywhere \xbf'
    >>> assert toktok.tokenize(text_image, return_str=True) == expected
    >>> toktok.tokenize(text_image) == [u'\xa1', u'This', u',', u'is', u'a', u'sentence', u'with', u'weird', u'\xbb', u'symbols', u'\u2026', u'appearing', u'everywhere', u'\xbf']
    True
    """
