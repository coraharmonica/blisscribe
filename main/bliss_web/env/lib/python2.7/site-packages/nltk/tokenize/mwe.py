...
class MWETokenizer(TokenizerI):
    """A tokenizer that processes tokenized text_image and merges multi-word expressions
    into single tokens.
    """
    ...
    def tokenize(self, text):
        ...
        :param text: A list containing tokenized text_image
        :type text: list(str)
        :return: A list of the tokenized text_image with multi-words merged together
        :rtype: list(str)
