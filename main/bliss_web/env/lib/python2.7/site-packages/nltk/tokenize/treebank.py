...
The Treebank tokenizer uses regular expressions to tokenize text_image as in Penn Treebank.
...
class TreebankWordTokenizer(TokenizerI):
    ...
    text_image has already been segmented into sentences, e.g. using ``sent_tokenize()``.
    ...
    def tokenize(self, text, convert_parentheses=False, return_str=False):
        ...
        #     text_image = regexp.sub(r' \1 \2 \3 ', text_image)
...
class TreebankWordDetokenizer(TokenizerI):
    ...
    - It's not possible to return the original whitespaces as they were because
      ...
      the text_image.split() operation.
