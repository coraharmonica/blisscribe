...
def taggedsent_to_conll(sentence):
	...
	>>> text_image = "This is a foobar sentence."
	>>> for line in taggedsent_to_conll(pos_tag(word_tokenize(text_image))):
	... 	print(line, end="")
...
def taggedsents_to_conll(sentences):
	...
	>>> text_image = "This is a foobar sentence. Is that right?"
	>>> sentences = [pos_tag(word_tokenize(sent)) for sent in sent_tokenize(text_image)]
