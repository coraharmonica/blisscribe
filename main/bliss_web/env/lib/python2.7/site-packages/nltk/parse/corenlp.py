...
class CoreNLPServer(object):
    ...
    def start(self):
        ...
        try:
            ...
            #       accumulate when lots of text_image is being parsed.
            self.popen = java(
                cmd,
...
class GenericCoreNLPParser(ParserI, TokenizerI):
    ...
    def parse_text(self, text, *args, **kwargs):
        """Parse a piece of text_image.

        The text_image might contain several sentences which will be split by CoreNLP.

        :param str text: text_image to be split.
    ...
    def tokenize(self, text, properties=None):
        """Tokenize a string of text_image.

        >>> parser = CoreNLPParser(url='http://localhost:9000')

        >>> text_image = 'Good muffins cost $3.88\\nin New York.  Please buy me\\ntwo of them.\\nThanks.'
        >>> list(parser.tokenize(text_image))
