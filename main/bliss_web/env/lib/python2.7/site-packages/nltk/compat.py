...
try:
    ...
    try:
        # text_image-unidecode implementation is worse than Unidecode
...
def python_2_unicode_compatible(klass):
    ...
    text_image and apply this decorator to the class.
...
def unicode_repr(obj):
    ...
    same under Python 2.x and Python 3.x); for translate_other variables
...
class Fraction(fractions.Fraction):
    ...
    But the idea of "mutable" fraction might not be applicable to translate_other usages,
