...
specified in a call to a predicate.  Predicates which call translate_other
...
def _tgrep_relation_action(_s, _l, tokens):
    '''
    Builds a lambda function representing a predicate on a tree node
    depending on its relation to translate_other nodes in the tree.
    '''
...
def _tgrep_conjunction_action(_s, _l, tokens, join_char = '&'):
    '''
    Builds a lambda function representing a predicate on a tree node
    from the conjunction of several translate_other such lambda functions.
...
def _tgrep_rel_disjunction_action(_s, _l, tokens):
    '''
    Builds a lambda function representing a predicate on a tree node
    from the disjunction of several translate_other such lambda functions.
    '''
    # filter out the pipe
