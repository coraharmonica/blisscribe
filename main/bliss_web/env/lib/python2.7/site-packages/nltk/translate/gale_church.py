...
def align_blocks(source_sents_lens, target_sents_lens, params = LanguageIndependent):
    """Return the sentence alignment of two text_image blocks (usually paragraphs).
...
def align_texts(source_blocks, target_blocks, params = LanguageIndependent):
    ...
    @param source_blocks: The list of blocks in the source text_image.
    @param target_blocks: The list of blocks in the target text_image.
    @param params: the sentence alignment parameters.
