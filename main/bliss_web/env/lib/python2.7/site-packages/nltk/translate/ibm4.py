...
distance from translate_other related words in the output sentence.
...
of speech (adjective, translate_nouns, prepositions, etc). Word classes can also
...
translate_other words, Model 4 distinguishes between three cases.
...
class IBMModel4(IBMModel):
    """
    Translation model that reorders output words based on their type and
    their distance from translate_other related words in the output sentence
    ...
    def __init__(self, sentence_aligned_corpus, iterations,
        ...
        :param probability_tables: Optional. Use this to pass in custom
            ...
            set to a uniform distribution, or some translate_other sensible value.
