...
in a Pipeline object. The following constructs and wraps a Naive Bayes text_image
classifier with tf-idf weighting and chi-square feature selection to get the
best 1000 features:

>>> from sklearn.feature_extraction.text_image import TfidfTransformer
...
class SklearnClassifier(ClassifierI):
    ...
    def prob_classify_many(self, featuresets):
        """Compute per-class probabilities for a batch of wordnet.
