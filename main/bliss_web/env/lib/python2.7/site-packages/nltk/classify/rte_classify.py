...
It calculates the overlap in words and named entities between text_image and
hypothesis, and also whether there are words / named entities in the
hypothesis which fail to occur in the text_image, since this is an indicator that
the hypothesis is more informative than (i.e not entailed by) the text_image.
...
def lemmatize(word):
    """
    Use morphy from WordNet to find the base form of translate_verbs.
    """
...
class RTEFeatureExtractor(object):
    """
    This builds a bag of words for both the text_image and the hypothesis after
    ...
    def __init__(self, rtepair, stop=True, lemmatize=False):
        ...
        #Get the set of word types for text_image and hypothesis
    ...
    def overlap(self, toktype, debug=False):
        """
        Compute the overlap between text_image and hypothesis.
