...
partially-labeled training sets. In translate_other words, assume we want to build a classifier
...
examples for one of the classes, and translate_other, unlabeled, examples.
