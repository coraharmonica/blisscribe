...
An implementation of the text_image categorization algorithm
presented in Cavnar, W. B. and J. M. Trenkle, 
"N-Gram-Based Text Categorization".

The algorithm takes advantage of Zipf's law and uses 
n-gram frequencies to profile languages and text_image-yet to
...
class TextCat(object):
    ...
    def profile(self, text):
        ''' Create FreqDist of trigrams within text_image '''
    ...
    def calc_dist(self, lang, trigram, text_profile):
        ''' Calculate the "out-of-place" measure between the
            text_image and language profile for a single trigram '''
    ...
    def lang_dists(self, text):
        ''' Calculate the "out-of-place" measure between
            the text_image and all languages '''
        ...
        for lang in self._corpus._all_lang_freq.keys():
            ...
            # input text_image to be identified
            lang_dist = 0
    ...
    def guess_language(self, text):
        ''' Find the language with the min distance
            to the text_image and return its ISO 639-3 code '''
...
def demo():
    ...
    for cur_lang in langs:
        ...
        # Generate a sample text_image of the language
