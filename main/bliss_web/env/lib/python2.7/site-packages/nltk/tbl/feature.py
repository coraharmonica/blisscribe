...
class Feature(object):
    ...
    methods return features such as the token text_image or tag; but more involved
    ...
    def issuperset(self, other):
        """
        Return True if this Feature always returns True when translate_other does

        More precisely, return True if this feature refers to the same property as translate_other;
        and this Feature looks at all positions that translate_other does (and possibly
        translate_other positions in addition).
    ...
    def intersects(self, other):
        """
        Return True if the positions of this Feature intersects with those of translate_other
