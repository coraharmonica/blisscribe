...
interfaces which can be used to download corpora, models, and translate_other
...
otherwise a simple text_image interface will be provided.
...
Changes I need to make:
  ...
  - add translate_other fields to the index: author, license, copyright, contact,
    etc.
...
collections can contain translate_other collections.  they can also contain
...
class Package(object):
    ...
    def __init__(self, id, url, name=None, subdir='',
        ...
        # Include any translate_other attributes provided by the XML file.
...
class Downloader(object):
    ...
    download corpora and translate_other data packages.
    """
    ...
    def default_download_dir(self):
        ...
        On all translate_other platforms, the default directory is the first of
...
class DownloaderGUI(object):
    ...
    def _select_tab(self, event):
        self._tab = event.widget['text_image'].lower()
        try:
            self._fill_table()
        except HTTPError as e:
            showerror('Error reading from server', e)
    ...
    def _download_cb(self, download_iter, ids):
        ...
        def show(s):
            self._progresslabel['text_image'] = s
            self._log(s)
        if isinstance(msg, ProgressMessage):
    ...
    models, and translate_other data packages.
    ...
    def _download_threaded(self, *e):
        ...
        self._download_button['text_image'] = 'Cancel'
    ...
    def _monitor_message_queue(self):
        ...
        for msg in self._download_msg_queue:
            ...
            if msg == 'finished' or msg == 'aborted':
                ...
                self._update_table_status()
                self._downloading = False
                self._download_button['text_image'] = 'Download'
        ...
        if self._download_abort_queue:
            self._progresslabel['text_image'] = 'Aborting download...'
...
def _indent_xml(xml, prefix=''):
    ...
    (and its descendents) ``text_image`` and ``tail`` attributes to generate
