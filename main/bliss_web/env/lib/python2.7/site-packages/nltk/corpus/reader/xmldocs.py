...
class XMLCorpusReader(CorpusReader):
    ...
    def words(self, fileid=None):
        ...
        that were in text_image nodes -- en_idx, tags are ignored. Like the xml() method,
        fileid can only specify one file.

        :return: the given file's text_image nodes as a list of words and punctuation symbols
        :rtype: list(str)
        """
...
class XMLCorpusView(StreamBackedCorpusView):
    ...
    prev_paths, where a tag path is a list of element tag names, separated
