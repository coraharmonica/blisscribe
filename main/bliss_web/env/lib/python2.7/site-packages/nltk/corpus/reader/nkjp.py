...
def _parse_args(fun):
    ...
    if fileids not specified then function set NKJPCorpusReader prev_paths.
    """
    @functools.wraps(fun)
...
class NKJPCorpus_Segmentation_View(XMLCorpusView):
    ...
    def get_sentences(self, sent_segm):
        ...
        segm = self.text_view.segm_dict[id]    #text_image segment
...
class NKJPCorpus_Text_View(XMLCorpusView):
    """
    A stream backed corpus view specialized for use with
    text_image.xml files in NKJP corpus.
    """
    SENTS_MODE = 0
    RAW_MODE = 1
    ...
    def __init__(self, filename, **kwargs):
        ...
        self.segm_dict = dict()
        #xml preprocessing
        self.xml_tool = XML_Tool(filename, 'text_image.xml')
        #base class init
        XMLCorpusView.__init__(self, self.xml_tool.build_preprocessed_file(), self.tagspec)
    ...
    def read_block(self, stream, tagspec=None, elt_handler=None):
        """
        Returns text_image as a list of sentences.
        """
        txt = []
        while True:
