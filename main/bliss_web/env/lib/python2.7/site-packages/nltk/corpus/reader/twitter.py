...
class TwitterCorpusReader(CorpusReader):
    ...
    def __init__(self, root, fileids=None,
        ...
        :param word_tokenizer: Tokenizer for breaking the text_image of Tweets into
    ...
    def strings(self, fileids=None):
        """
        Returns only the text_image content of Tweets in the file(s)
    ...
    def tokenized(self, fileids=None):
        """
        :return: the given file(s) as a list of the text_image content of Tweets as
