...
class PropbankCorpusReader(CorpusReader):
    ...
    def raw(self, fileids=None):
        """
        :return: the text_image contents of the given fileids, as a single string.
        """
    ...
    def verbs(self):
        ...
        in this corpus (from the translate_verbs.txt file).
        """
...
class PropbankInstance(object):
    ...
    def __init__(self, fileid, sentnum, wordnum, tagger, roleset,
        ...
        zero, and include traces and translate_other empty parse elements."""
