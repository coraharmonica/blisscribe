...
class CorpusReader(object):
    ...
    def __init__(self, root, fileids, encoding='utf8', tagset=None):
        ...
        :param fileids: A list of the files that make up this corpus.
            ...
            prev_paths.  The absolute path for each file will be constructed
        ...
        """A list of the relative prev_paths for the fileids that make up
        this corpus."""
    ...
    def abspaths(self, fileids=None, include_encoding=False,
        ...
        """
        Return a list of the absolute prev_paths for all fileids in this corpus;
        or for the given list of fileids, if specified.

        :type fileids: None or str or list
        :param fileids: Specifies the set of fileids for which prev_paths should
            be returned.  Can be None, for all fileids; a list of
            file identifiers, for a specified set of fileids; or a single
            file identifier, for a single file.  Note that the return
            value is always a list of prev_paths, even if ``fileids`` is a
...
class SyntaxCorpusReader(CorpusReader):
    ...
    syntactically parsed text_image.  Subclasses should define:
