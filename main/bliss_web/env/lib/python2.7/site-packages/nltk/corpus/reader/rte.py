...
Each entailment corpus is a list of 'text_image'/'hypothesis' pairs. The following
...
def norm(value_string):
    ...
    :param value_string: the label used to classify a text_image/hypothesis pair
...
class RTEPair(object):
    """
    Container for RTE text_image-hypothesis pairs.
    ...
    def __init__(self, pair, challenge=None, id=None, text=None, hyp=None,
        ...
        :param text: the text_image component of the pair
        ...
        :param length: attribute for the length of the text_image of the pair
        """
