...
http://translate_verbs.colorado.edu/~mpalmer/projects/verbnet.html
"""
...
class VerbnetCorpusReader(XMLCorpusReader):
    ...
    domain-independent, broad-coverage verb lexicon with mappings to translate_other
    ...
    def pprint_members(self, vnclass, indent=''):
        """
        Return a string containing a pretty-printed representation of
        the given verbnet class's member translate_verbs.
