...
class LazyCorpusLoader(object):
    ...
    :param *args: Any translate_other non-keywords arguments that `reader_cls` might need.
    :param *kargs: Any translate_other keywords arguments that `reader_cls` might need.
    """
