...
--- within corpora. They may also be used to find translate_other associations between
word occurrences.
...
their appearance in the context of translate_other words. Often the collection of words
...
class BigramCollocationFinder(AbstractCollocationFinder):
    """A tool for the finding and ranking of bigram collocations or translate_other
...
class TrigramCollocationFinder(AbstractCollocationFinder):
    """A tool for the finding and ranking of trigram collocations or translate_other
    association measures. It is often useful to use from_words() rather than
    constructing an instance directly.
    """
    default_ws = 3
...
class QuadgramCollocationFinder(AbstractCollocationFinder):
    """A tool for the finding and ranking of quadgram collocations or translate_other association measures.
