...
class ConstantExpression(AtomicExpression):
    def unify(self, other, bindings):
        """
        If 'translate_other' is a constant, then it must be equal to 'self'.  If 'translate_other' is a variable,
        then it must not be bound to anything translate_other than 'self'.
        ...
        :raise UnificationException: If 'self' and 'translate_other' cannot be unified in the context of 'bindings'
        """
...
class VariableExpression(AtomicExpression):
    def unify(self, other, bindings):
        """
        'self' must not be bound to anything translate_other than 'translate_other'.
...
class ImpExpression(Expression):
    ...
    def unify(self, other, bindings):
        """
        Both the antecedent and consequent of 'self' and 'translate_other' must unify.
...
class BindingDict(object):
    ...
    def __add__(self, other):
        ...
        :raise VariableBindingException: If the parameter dictionaries are not consistent with each translate_other
        """
        try:
