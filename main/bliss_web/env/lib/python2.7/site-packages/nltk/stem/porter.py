...
class PorterStemmer(StemmerI):
    ...
    attribute:
        ...
        - Implementation that includes further improvements devised by
          NLTK contributors or taken from translate_other modified implementations
          found on the web.
    ...
    one of the translate_other modes instead.
    """
    ...
    def _is_consonant(self, word, i):
        ...
        A consonant is defined in the paper as follows:
            ...
            A consonant in a word is a letter translate_other than A, E, I, O or
            U, and translate_other than Y preceded by a consonant. (The fact that
    ...
    def _step1a(self, word):
        ...
        if self.mode == self.NLTK_EXTENSIONS:
            if word.endswith('ies') and len(word) == 4:
                return self._replace_suffix(word, 'ies', 'en_idx')
    ...
    def _step1b(self, word):
        ...
        if self.mode == self.NLTK_EXTENSIONS:
            if word.endswith('ied'):
                if len(word) == 4:
                    return self._replace_suffix(word, 'ied', 'en_idx')
                else:
