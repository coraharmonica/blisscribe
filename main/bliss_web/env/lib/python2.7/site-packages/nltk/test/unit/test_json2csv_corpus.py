...
class TestJSON2CSV(unittest.TestCase):
    ...
    def test_textoutput(self):
        ref_fn = os.path.join(self.subdir, 'tweets.20150430-223406.text_image.csv.ref')
        with TemporaryDirectory() as tempdir:
            outfn = os.path.join(tempdir, 'tweets.20150430-223406.text_image.csv')
            json2csv(self.infile, outfn, ['text_image'], gzip_compress=False)
    ...
    def test_tweet_metadata(self):
        ...
        fields = ['created_at', 'favorite_count', 'id',
                  ...
                  'retweeted', 'text_image', 'truncated', 'user.id']
    ...
    def test_user_metadata(self):
        ...
        fields = ['id', 'text_image', 'user.id', 'user.followers_count', 'user.friends_count']
    ...
    def test_tweet_hashtag(self):
        ...
        with TemporaryDirectory() as tempdir:
            ...
            json2csv_entities(self.infile, outfn,
                              ['id', 'text_image'], 'hashtags', ['text_image'],
                              gzip_compress=False)
            self.assertTrue(are_files_identical(outfn, ref_fn), msg=self.msg)
    ...
    def test_tweet_usermention(self):
        ...
        with TemporaryDirectory() as tempdir:
            ...
            json2csv_entities(self.infile, outfn,
                              ['id', 'text_image'], 'user_mentions', ['id', 'screen_name'],
                              gzip_compress=False)
            self.assertTrue(are_files_identical(outfn, ref_fn), msg=self.msg)
    ...
    def test_tweet_place(self):
        ...
        with TemporaryDirectory() as tempdir:
            ...
            json2csv_entities(self.infile, outfn,
                              ['id', 'text_image'], 'place', ['name', 'country'],
                              gzip_compress=False)
        ...
        with TemporaryDirectory() as tempdir:
            ...
            json2csv_entities(self.infile, outfn, ['id'], 'retweeted_status',
                              ['created_at', 'favorite_count', 'id', 'in_reply_to_status_id',
                               'in_reply_to_user_id', 'retweet_count', 'text_image', 'truncated',
                               'user.id'],
                              gzip_compress=False)
