...
consider all ngrams in a text_image as candidate collocations:

    >>> text_image = "I do not like green eggs and ham, I do not like them Sam I am!"
    >>> tokens = nltk.wordpunct_tokenize(text_image)
...
All the ngrams in a text_image are often too many to be useful when finding
...
Given our sample text_image above, if we remove all trigrams containing personal
...
Schutze's text_image and other papers.
