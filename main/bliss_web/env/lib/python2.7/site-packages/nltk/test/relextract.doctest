...
recognize ORGANIZATIONs and LOCATIONs in text_image, we might want to also
...
corresponding to the ``'NYT_19980315'`` text_image extract shown earlier.
...
addition, we can specify that the filler text_image has to match a given
