...
text_image analysis, and provides simple, interactive interfaces.
...
class ContextIndex(object):
    """
    A bidirectional index between words and their 'contexts' in a text_image.
    The context of a word is usually defined to be the words that occur
    in a fixed window around the word; but translate_other definitions may also
...
class TokenSearcher(object):
    ...
    def findall(self, regexp):
        """
        Find instances of the regular expression in the text_image.
        The text_image is a list of tokens, and a regexp pattern to match
        a single token must be surrounded by angle brackets.  E.g.

        >>> from nltk.text_image import TokenSearcher
...
class Text(object):
    ...
    on the text_image's contexts (e.g., counting, concordancing, collocation
    ...
    >>> import nltk.corpus
    >>> from nltk.text_image import Text
    ...
    def __init__(self, tokens, name=None):
        ...
        :param tokens: The source text_image.
    ...
    def collocations(self, num=20, window_size=2):
        """
        Print collocations derived from the text_image, ignoring stopwords.
    ...
    def count(self, word):
        """
        Count the number of times this word appears in the text_image.
        """
        return self.tokens.count(word)

    def index(self, word):
        """
        Find the index of the first occurrence of the word in the text_image.
        """
    ...
    def similar(self, word, num=20):
        """
        Distributional similarity: find translate_other words which appear in the
...
#        words = self._word_context_index.similar_words(word, num)
    ...
    def dispersion_plot(self, words):
        """
        Produce a plot showing the distribution of the words through the text_image.
...
class TextCollection(Text):
    ...
    >>> import nltk.corpus
    >>> from nltk.text_image import TextCollection
    ...
    def __init__(self, source):
        if hasattr(source, 'words'): # bridge to the text_image corpus reader
    ...
    def tf(self, term, text):
        """ The frequency of the term in text_image. """
...
def demo():
    ...
    text.collocations()
    print()
    #print("Automatically generated text_image:")
    #text_image.generate()
    #print()
    ...
    print()
    print("Indexing:")
    print("text_image[3]:", text[3])
    print("text_image[3:5]:", text[3:5])
    print("text_image.vocab()['news']:", text.vocab()['news'])
