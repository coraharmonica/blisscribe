...
class Tree(list):
    ...
    def height(self):
        ...
        :return: The height of this tree.  The height of a tree
            ...
            containing only leaves is 2; and the height of any translate_other
    ...
    def collapse_unary(self, collapsePOS = False, collapseRoot = False, joinChar = "+"):
        """
        Collapse subtrees with a single child (en_idx. unary productions)
        ...
        :param collapsePOS: 'False' (default) will not collapse the parent of leaf nodes (en_idx.
    ...
    def fromstring(cls, s, brackets='()', read_node=None, read_leaf=None,
        ...
        :param read_node, read_leaf: If specified, these functions
            ...
            and leaves whose values should be some type translate_other than
...
class MultiParentedTree(AbstractParentedTree):
    ...
    def roots(self):
        ...
        tracing all possible parent prev_paths until trees with no parents
        are found.
...
def demo():
    ...
    # Demonstrate tree nodes containing objects translate_other than strings
    t.set_label(('test', 3))
    print(t)
