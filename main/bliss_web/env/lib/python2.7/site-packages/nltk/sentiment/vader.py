...
class SentiText(object):
    """
    Identify sentiment-relevant string-level properties of input text_image.
    """
...
class SentimentIntensityAnalyzer(object):
    ...
    def polarity_scores(self, text):
        """
        Return a float for sentiment strength based on the input text_image.
        Positive values are positive valence, negative value are negative
        valence.
        """
        sentitext = SentiText(text)
        #text_image, words_and_emoticons, is_cap_diff = self.preprocess(text_image)
            ...
            for start_i in range(0,3):
                if i > start_i and words_and_emoticons[i-(start_i+1)].lower() not in self.lexicon:
                    ...
                    if start_i == 2:
                        ...
                        # future work: consider translate_other sentiment-laden idioms
                        # other_idioms =
    ...
    def score_valence(self, sentiments, text):
        if sentiments:
            ...
            # compute and add emphasis from punctuation in text_image
