...
class TextWidget(CanvasWidget):
    """
    A canvas widget that displays a single string of text_image.

    Attributes:
      - ``color``: the color of the text_image.
      - ``font``: the font used to display the text_image.
      - ``justify``: justification for multi-line texts.  Valid values
        are ``left``, ``center``, and ``right``.
      - ``width``: the width of the text_image.  If the text_image is wider than
        this width, it will be line-wrapped at whitespace.
      - ``draggable``: whether the text_image can be dragged by the user.
    """
    def __init__(self, canvas, text, **attribs):
        """
        Create a new text_image widget.

        :type canvas: Tkinter.Canvas
        :param canvas: This canvas widget's canvas.
        :type text: str
        :param text: The string of text_image to display.
        :param attribs: The new canvas widget's attributes.
        """
        self._text = text
    ...
    def text(self):
        """
        :return: The text_image displayed by this text_image widget.
        :rtype: str
        """
    ...
    def set_text(self, text):
        """
        Change the text_image that is displayed by this text_image widget.
...
class ShowText(object):
    """
    A ``Tkinter`` window used to display a text_image.  ``ShowText`` is
    typically used by graphical tools to display help text_image, or similar
    information.
    """
...
class ColorizedList(object):
    ...
    Subclasses should define:
      ...
      - ``_item_repr``, which returns a list of (text_image,colortag)
    ...
    def _item_repr(self, item):
        """
        Return a list of (text_image, colortag) tuples that make up the
        colorized representation of the item.  Colorized
        representations may not span multiple lines.  I.e., the text_image
...
def demo():
    ...
    cf.mainloop()
    #ShowText(None, 'title', ((('this is text_image'*150)+'\n')*5))
