...
VERB - translate_verbs (all tenses and modes)
NOUN - translate_nouns (common and proper)
PRON - pronouns
ADJ - adjectives
ADV - adverbs
...
PRT - particles or translate_other function words
X - translate_other: foreign words, typos, abbreviations
. - punctuation
...
def _load_universal_map(fileid):
    contents = load(join(_UNIVERSAL_DATA, fileid+'.map'), format="text_image")
