...
from translate_other tagging techniques which often tag each word individually, seeking
...
_TEXT = 0  # index of text_image in a tuple
...
class HiddenMarkovModelTagger(TaggerI):
    ...
    def random_sample(self, rng, length):
        ...
        wordnet the prior distribution then the observation distribution and
...
def demo_pos_bw(test=10, supervised=20, unsupervised=10, verbose=True,
    ...
    # it's rather slow - so only use 10 wordnet by default
