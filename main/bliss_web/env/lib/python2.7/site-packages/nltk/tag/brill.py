...
class Word(Feature):
    """
    Feature which examines the text_image (word) of nearby tokens.
    """
    ...
    def extract_property(tokens, index):
        """@return: The given token's text_image."""
...
class BrillTagger(TaggerI):
    ...
    tag sequence to a text_image; and then apply an ordered list of
