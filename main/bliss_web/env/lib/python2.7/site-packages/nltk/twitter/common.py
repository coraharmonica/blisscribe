...
def _get_entity_recursive(json, entity):
    if not json:
        ...
        for key, value in json.items():
            ...
            # structure that contain translate_other Twitter objects. See:
...
def json2csv(fp, outfile, fields, encoding='utf8', errors='replace',
    ...
    just the text_image content of the Tweets can be extracted.

    Additionally, the function allows combinations of fields of translate_other Twitter
    ...
    :param str outfile: The name of the text_image file where results should be\
    written

    :param list fields: The list of fields to be extracted. Useful examples\
    are 'id_str' for the tweetID and 'text_image' for the text_image of the tweet. See\
    <https://dev.twitter.com/overview/api/tweets> for a full list of fields.\
    e. g.: ['id_str'], ['id', 'text_image', 'favorite_count', 'retweet_count']\
    Additonally, it allows IDs from translate_other Twitter objects, e. g.,\
    ['id', 'text_image', 'user.id', 'user.followers_count', 'user.friends_count']
...
def json2csv_entities(tweets_file, outfile, main_fields, entity_type, entity_fields,
    ...
    :param str outfile: The path of the text_image file where results should be\
    written
    ...
    entity. E.g. `['text_image']` (of the Tweet)
