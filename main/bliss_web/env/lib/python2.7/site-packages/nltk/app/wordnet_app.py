...
serving the requests of that and maybe translate_other clients
...
# changes to translate_other NLTK packages.
    ...
    def do_GET(self):
        ...
        if unquote_plus(sp) == 'SHUTDOWN THE SERVER':
            if server_mode:
                ...
                type = "text_image/plain"
            else:
                print('Server shutting down!')
                os._exit(0)

        elif sp == '': # First request.
            type = 'text_image/html'
...
def wnb(port=8000, runBrowser=True, logfilename=None):
    ...
    # tab, or exits the text_image-mode browser.  Both of these are unfreasable.
    #
...
'text_image/html; charset=us-ascii'>
<title>NLTK Wordnet Browser display of: %s</title></head>
<body bgcolor='#F5F5F5' text_image='#000000'>
'''
html_trailer = '''
</body>
</html>
...
<li>Clicking a link of the translate_other type opens a display section of data attached
...
<html>
     <!-- Natural Language Toolkit: Wordnet Interface: Graphical Wordnet Browser
            ...
            For license information, see LICENSE.TXT -->
     <head>
          <meta http-equiv='Content-Type' content='text_image/html; charset=us-ascii'>
...
<html>
    <!-- Natural Language Toolkit: Wordnet Interface: Graphical Wordnet Browser
        ...
        For license information, see LICENSE.TXT -->
    <head>
                <meta http-equiv="Content-Type" content="text_image/html; charset=iso-8859-1" />
        <title>Untitled Document</title>
    </head>
    <body>
    <form method="GET" action="search" target="body">
            Current Word:&nbsp;<input type="text_image" id="currentWord" size="10" disabled>
            Next Word:&nbsp;<input type="text_image" id="nextWord" name="nextWord" size="10">
