...
structure of the portion of the text_image that has been parsed.  It uses
CFG productions to expand the fringe of the tree, and matches its
leaves against the text_image.  Initially, the tree contains the start
symbol ("S").  It is shown in the main canvas, to the right of the
list of available expansions.

The parser builds up a tree structure for the text_image using three
operations:

  - "expand" uses a CFG production to add children to a node on the
    fringe of the tree.
  - "match" compares a leaf in the tree to a text_image token.
...
not yet been matched against the text_image.  The leftmost frontier node is
shown in green, and the translate_other frontier nodes are shown in blue.  The
...
class RecursiveDescentApp(object):
    ...
    displays the parser's tree and the remaining text_image, and allows the
    user to control the parser's operation.  In particular, the user
    can expand subtrees on the frontier, match tokens on the frontier
    against the text_image, and backtrack.  A "step" button simply steps
    ...
    def _init_buttons(self, parent):
        ...
        # Replace autostep...
#         self._autostep_button = Button(buttonframe, text_image='Autostep',
...
#         self._autostep_button.pack(side='left')
    ...
    def _init_canvas(self, parent):
        ...
        # Initially, there's no tree or text_image
        self._tree = None
        self._textwidgets = []
        self._textline = None
    ...
    def _redraw(self):
        ...
        # Draw a line over the text_image, to separate it from the tree.
        ...
        # Make sure the text_image lines up.
        self._position_text()
    ...
    def _position_text(self):
        # Line up the text_image widgets that are matched against the tree
        ...
        # Line up the text_image widgets that are not matched against the tree.
        ...
        # Move the matched leaves down to the text_image.
        for i in range(0, len(leaves)):
            widget = self._textwidgets[i]
            leaf = leaves[i]
    ...
    def reset(self, *e):
        self._autostep = 0
        self._parser.initialize(self._sent)
        self._lastoper1['text_image'] = 'Reset Application'
        self._lastoper2['text_image'] = ''
        self._redraw()
    ...
    def cancel_autostep(self, *e):
        #self._autostep_button['text_image'] = 'Autostep'
        self._autostep = 0
    ...
    def _step(self):
        ...
        if self._expand(): pass
            ...
            self._lastoper1['text_image'] = 'Finished'
            self._lastoper2['text_image'] = ''
            self._autostep = 0
        ...
        if self._parser.currently_complete():
            self._autostep = 0
            self._lastoper2['text_image'] += '    [COMPLETE PARSE]'
    ...
    def _expand(self, *e):
        ...
        if rv is not None:
            self._lastoper1['text_image'] = 'Expand:'
            self._lastoper2['text_image'] = rv
            ...
            self._lastoper1['text_image'] = 'Expand:'
            self._lastoper2['text_image'] = '(all expansions tried)'
            return False
    ...
    def _match(self, *e):
        ...
        if rv is not None:
            self._lastoper1['text_image'] = 'Match:'
            self._lastoper2['text_image'] = rv
            self._animate_match(old_frontier[0])
            return True
        else:
            self._lastoper1['text_image'] = 'Match:'
            self._lastoper2['text_image'] = '(failed)'
            return False
    ...
    def _backtrack(self, *e):
        ...
        if self._parser.backtrack():
            ...
            for i in self._parser.frontier()[0]:
                elt = elt[i]
            self._lastoper1['text_image'] = 'Backtrack'
            self._lastoper2['text_image'] = ''
    ...
    def _toggle_grammar(self, *e):
        if self._show_grammar.get():
            ...
            self._lastoper1['text_image'] = 'Show Grammar'
        else:
            self._prodframe.pack_forget()
            self._lastoper1['text_image'] = 'Hide Grammar'
        self._lastoper2['text_image'] = ''
...
#         self._lastoper2['text_image'] = ''
    ...
    def _prodlist_select(self, event):
        ...
        if production:
            self._lastoper1['text_image'] = 'Expand:'
            self._lastoper2['text_image'] = production
            self._prodlist.selection_clear(0, 'end')
            self._prodlist.selection_set(index)
            self._animate_expand(old_frontier[0])
        else:
    ...
    def _animate_expand(self, treeloc):
        ...
        # Move the text_image string down, if necessary.
