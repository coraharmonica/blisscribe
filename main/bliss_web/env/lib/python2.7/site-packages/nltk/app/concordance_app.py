...
class ConcordanceSearchView(object):
    ...
    #Percentage of text_image left of the scrollbar position
    ...
    def _init_results_box(self, parent):
        ...
        #there is no translate_other way of avoiding the overlap of scrollbars while using pack layout manager!!!
    ...
    def handle_error_loading_corpus(self, event):
        self.status['text_image'] = 'Error in loading ' + self.var.get()
        self.unfreeze_editable()
        self.clear_all()
        self.freeze_editable()

    def handle_corpus_loaded(self, event):
        self.status['text_image'] = self.var.get() + ' is loaded'
        self.unfreeze_editable()
        self.clear_all()
    ...
    def handle_search_terminated(self, event):
        ...
        self.status['text_image'] = ''
        if len(results) == 0:
            self.status['text_image'] = 'No results found for ' + self.model.query
        else:
    ...
    def handle_search_error(self, event):
        self.status['text_image'] = 'Error in query ' + self.model.query
        self.unfreeze_editable()
    ...
    def load_corpus(self, selection):
        if self.model.selected_corpus != selection:
            self.status['text_image'] = 'Loading ' + selection + '...'
            self.freeze_editable()
    ...
    def search(self):
        ...
        self.status['text_image']  = 'Searching for ' + query
        self.freeze_editable()
