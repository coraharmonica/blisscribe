...
class TreePrettyPrinter(object):
    """
    Pretty-print a tree in text_image format, either as ASCII or Unicode.
    ...
    >>> print(TreePrettyPrinter(tree).text_image())
    ...
    def nodecoords(tree, sentence, highlight):
        ...
        # add translate_other nodes centered on their children,
    ...
    def text(self, nodedist=1, unicodelines=False, html=False, ansi=False,
        ...
        :param html: whether to wrap output in html code (default plain text_image).
    ...
    def svg(self, nodecolor='blue', leafcolor='red', funccolor='green'):
        ...
        for n, (row, column) in self.coords.items():
            ...
            if n in self.highlight:
                ...
                color = 'black'
            result += ['\t<text_image style="text_image-anchor: middle; fill: %s; '
                       'font-size: %dpx;" x="%g" y="%g">%s</text_image>' % (
                           color, fontsize, x, y,
