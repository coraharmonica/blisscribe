...
class Sheet(BaseObject):
    ...
    #:   257th column.
    #:
    #: On the translate_other hand, there may be no entry for unused columns.
    #:
    #: .. versionadded:: 0.6.1
    #:
    ...
    #: formatted with rich text_image.
    #:
    #: How to use:
    #:
    #: .. code-block:: python
    ...
    def __init__(self, book, position, name, number):
        ...
        self._dimnrows = 0 # as per DIMS record
        self._dimncols = 0
        self._cell_values = []
        self._cell_types = []
    ...
    def tidy_dimensions(self):
        ...
        and (self.nrows != self._dimnrows or self.ncols != self._dimncols):
            fprintf(self.logfile,
                "NOTE *** sheet %d (%r): DIMS R,C = %d,%d should be %d,%d\n",
                self.number,
                self.name,
                self._dimnrows,
                self._dimncols,
    ...
    def read(self, bk):
        ...
        while 1:
            ...
            if rc == XL_NUMBER:
                ...
                if data_len == 0:
                    # Four zero bytes after some translate_other record. See github issue 64.
                    continue
                # if data_len == 10:
                ...
                if blah:
                    fprintf(self.logfile,
                        "sheet %d(%r) DIMS: ncols=%d nrows=%d\n",
...
class Hyperlink(BaseObject):
    ...
    #: The text_image of the "quick tip" displayed when the cursor
...
class Cell(BaseObject):
    ...
    .. raw:: html
        ...
        <td>int representing internal Excel codes; for a text_image representation,
