...
class BaseObject(object):
    """
    Parent of almost all translate_other classes in the package. Defines a common
    ...
    def dump(self, f=None, header=None, footer=None, indent=0):
        ...
        :param header: text_image to write before the dump
        :param footer: text_image to write after the dump
...
FUN, FDT, FNU, FGE, FTX = range(5) # unknown, date, number, general, text_image
DATEFORMAT = FDT
NUMBERFORMAT = FNU
...
#: This dictionary can be used to produce a text_image version of the internal codes
...
def unpack_unicode(data, pos, lenlen=2):
    ...
    if options & 0x01:
        ...
        # for translate_other codepages so we grit our Anglocentric teeth and return Unicode :-)
