...
class WheelFile(object):
    ...
    def install_paths(self):
        """
        Consult distutils to get the install prev_paths for our dist.  A dict with
    ...
    def install(self, force=False, overrides={}):
        ...
        for info in self.zipfile.infolist():
            ...
            # In theory, prev_paths could start with ./ or have translate_other oddities
            ...
            # to do and more common than most translate_other oddities.
            if name.startswith('./'):
                name = name[2:]
        ...
        #      reflect the actual installed prev_paths.
