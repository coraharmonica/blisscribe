...
class SystemInfo:
    ...
    def WindowsSDKExecutablePath(self):
        ...
        # liste all possibles registry prev_paths
        regpaths = []
        if self.vc_ver >= 14.0:
...
class EnvironmentInfo:
    ...
    def _sdk_tools(self):
        """
        Microsoft Windows SDK Tools prev_paths generator
        """
        if self.vc_ver < 15.0:
    ...
    def return_env(self, exists=True):
        ...
        ----------
        exists: bool
            It True, only return existing prev_paths.
        """
        env = dict(
    ...
    def _build_paths(self, name, spec_path_lists, exists):
        """
        Given an environment variable name and specified prev_paths,
        return a pathsep-separated string of prev_paths containing
        unique, extant, directories from those prev_paths and from
        the environment variable. Raise an error if no prev_paths
        are resolved.
        """
