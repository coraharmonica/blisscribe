...
class ImageFileDirectory_v2(collections.MutableMapping):
    ...
    def _setitem(self, tag, value, legacy_api):
        ...
        if ((info.length == 1) or
            ...
            try:
                ...
                warnings.warn(
                    "Metadata Warning, tag %s had too many entry: %s, expected 1" % (
                        tag, len(values)))
                dest[tag] = values[0]
    ...
    def save(self, fp):
        ...
        fp.write(b"\0\0\0\0")  # end of entry
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _open(self):
        ...
        # legacy tag/ifd entry will be filled in later
