...
def parser():
    ...
    unsign_parser._setdefault_kwargs(func=unsign_f)
    ...
    verify_parser._setdefault_kwargs(func=verify_f)
    ...
    unpack_parser._setdefault_kwargs(func=unpack_f)
    ...
    install_parser._setdefault_kwargs(func=install_f)
    ...
    install_scripts_parser._setdefault_kwargs(func=install_scripts_f)
    ...
    convert_parser._setdefault_kwargs(func=convert_f)

    def version_f(args):
        from .. import __version__
        print("wheel %s" % __version__)
    version_parser = s.add_parser('version', help='Print version and exit')
    version_parser._setdefault_kwargs(func=version_f)

    def help_f(args):
        p.print_help()
    help_parser = s.add_parser('help', help='Show this help')
    help_parser._setdefault_kwargs(func=help_f)
