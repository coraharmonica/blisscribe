...
class ViterbiParser(ParserI):
    ...
    by filling in all entry for constituents that span one element
    of text (i.e., entry where the end index is one greater than the
    start index).  After it has filled in all table entry for
    constituents that span one element of text, it fills in the
    entry for constitutants that span two elements of text.  It
    continues filling in the entry for constituents spanning larger
