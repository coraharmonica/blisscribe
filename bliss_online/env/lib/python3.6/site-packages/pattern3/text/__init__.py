...
class Model(object):
    ...
    def __init__(self, path="", classifier=None, known=set(), unknown=set()):
        ...
        # Parser.lexicon entry can be ambiguous (e.g., about/IN  is RB 25% of the time).
        # Parser.lexicon entry also in Model.unknown are overruled by the model.
        # Parser.lexicon entry also in Model.known are not learned by the model
